...
using Sistema.Forms.modulo_recargas;
...
namespace Sistema
{
    public partial class Layout : BaseContext
    {
        ...
        {
            ListaProductos childForm = new ListaProductos(this);
            childForm.MdiParent = this;
            childForm.Show();
        }
        ...
        private void listadoToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                ListadoRecargas recargas = new ListadoRecargas();
        ...
        {
            if (Application.OpenForms["EditarRecargas"] == null)
            {
                EditarRecargas recargas = new EditarRecargas();
                recargas.MdiParent = this;
                recargas.Show();
            }
            else
            {
                Application.OpenForms["EditarRecargas"].Activate();
            }
        }

        private void saldoRecargasToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (Application.OpenForms["SaldoRecarga"] == null)
            {
                SaldosRecargas recargas = new SaldosRecargas();
                recargas.MdiParent = this;
                recargas.Show();
            }
            else
            {
                Application.OpenForms["SaldoRecarga"].Activate();
            }
        }
        ...
        private void configuraciónToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            ...
            //else
            //{
            //    Application.OpenForms["CategoriaProducto"].Activate();
            //}
        }
